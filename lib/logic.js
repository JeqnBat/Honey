 ...
 * 
 * @returns { string } number used as an horizontal index representing 1st line
 *                     of the selected day on the table
 */
const findDayIndex = (tag, data) => {
  let dayIndex
...
export { parser, dayPicker, readCol, readRow, findDayIndex, findNames, parseShift }